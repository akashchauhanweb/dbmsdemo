...
<?php
    ...
    $no_of_officers = mysqli_num_rows($test);
	$query="SELECT * FROM station";
    $test = mysqli_query($conn,$query);
    $no_of_stations = mysqli_num_rows($test);
	$query="SELECT * FROM command";
    $test = mysqli_query($conn,$query);
    $no_of_commands = mysqli_num_rows($test);
	$query="SELECT * FROM jet";
    $test = mysqli_query($conn,$query);
    $no_of_jets = mysqli_num_rows($test);
?>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="dist/img/airlogo.png" alt="Admin Dashboard" class="brand-image img-circle elevation-3"
           style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            <a href="http://localhost:8080/Project/admindash/index.php" class="nav-link active">
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3> <?php echo $no_of_officers ?></h3>
                <p>Officers</p>
              </div>
              <div class="icon">
                <i class="icon ion-md-people"></i>
              </div>
              <a href="http://localhost:8080/Project/admindash/pages/tables/officers.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3><?php echo $no_of_stations ?></sup></h3>
              ...
              <a href="http://localhost:8080/Project/admindash/pages/tables/stations.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                <h3><?php echo $no_of_commands ?></h3>
                <p>Commands</p>
              </div>
              <div class="icon">
                <i class="icon ion-md-ribbon"></i>
              </div>
              <a href="http://localhost:8080/Project/admindash/pages/tables/commands.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              ...
              <a href="http://localhost:8080/Project/admindash/pages/tables/jets.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
