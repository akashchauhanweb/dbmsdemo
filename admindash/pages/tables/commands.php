...
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="http://localhost:8080/Project/admindash/pages/tables/commands.php" class="nav-link active">
              <i class="nav-icon fas fa-table"></i>
              <p>
                Commands
              </p>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form method=post action="deletecommands.php">
        <div class="card">
          ...
          <div class="card-body">
            <div id="jsGrid1" class="jsgrid" style="position: relative; height: 100%; width: 100%;">
			        <div class="jsgrid-grid-header jsgrid-header-scrollbar">
				        <table class="jsgrid-table">
					        <tr class="jsgrid-header-row">
						        <th class="jsgrid-header-cell jsgrid-header-sortable" style="width: 100px;">CommandID</th>
						        <th class="jsgrid-header-cell jsgrid-header-sortable" style="width: 100px;">Command Name</th>
						        <th class="jsgrid-header-cell jsgrid-header-sortable" style="width: 100px;">Region</th>
						        <th class="jsgrid-header-cell jsgrid-header-sortable" style="width: 100px;">CommanderID</th>
                    <th class="jsgrid-header-cell jsgrid-align-center jsgrid-header-sortable" style="width: 100px;">Select</th>
					        </tr>
				        </table>
				      </div>
                  ...
                  { ?>
                    <tr class="jsgrid-row">
								      <td class="jsgrid-cell" style="width: 100px;"><?php echo $res['cid'] ?></td>
								      <td class="jsgrid-cell" style="width: 100px;"><?php echo $res['cname'] ?></td>
								      <td class="jsgrid-cell" style="width: 100px;"><?php echo $res['region'] ?></td>
								      <td class="jsgrid-cell" style="width: 100px;"><?php echo $res['commanderid'] ?></td>
								      <td class="jsgrid-cell jsgrid-align-center" style="width: 100px;"><input name="checkbox[]" value="<?php echo $res['cid'] ?>" type="checkbox" enabled=""></td>
							      </tr>
                  <?php
                  }
                ?>
