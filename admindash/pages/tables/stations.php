...
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="http://localhost:8080/Project/admindash/pages/tables/stations.php" class="nav-link active">
              <i class="nav-icon fas fa-table"></i>
              <p>
                Stations
              </p>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form method="post" action="deletestations.php">  
        <div class="card">
            ...
            <div id="jsGrid1" class="jsgrid" style="position: relative; height: 100%; width: 100%;">
			        <div class="jsgrid-grid-header jsgrid-header-scrollbar">
				        <table class="jsgrid-table">
					        <tr class="jsgrid-header-row">
						        ...
						        <th class="jsgrid-header-cell jsgrid-header-sortable" style="width: 100px;">Station Name</th>
						        <th class="jsgrid-header-cell jsgrid-header-sortable" style="width: 100px;">Area</th>
                    ...
                    { ?>
                      <tr class="jsgrid-row">
								        ...
								        <td class="jsgrid-cell" style="width: 100px;"><?php echo $res['sname'] ?></td>
								        <td class="jsgrid-cell" style="width: 100px;"><?php echo $res['area'] ?></td>
								        <td class="jsgrid-cell" style="width: 100px;"><?php echo $res['cid'] ?></td>
								        <td class="jsgrid-cell jsgrid-align-center" style="width: 100px;"><input name="checkbox[]" value="<?php echo $res['sid'] ?>" type="checkbox" enabled=""></td>
							        </tr>
                    <?php
                    } 
                  ?>
