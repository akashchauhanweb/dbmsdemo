...
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="http://localhost:8080/Project/admindash/pages/tables/jets.php" class="nav-link active">
              <i class="nav-icon fas fa-table"></i>
              <p>
                Jets
              </p>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form method="post" action="deletejets.php">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Jet Details</h3>
          </div>
          <!-- /.card-header -->
          <?php
            include("conn.php");
          ...
          <div class="card-body">
            <div id="jsGrid1" class="jsgrid" style="position: relative; height: 100%; width: 100%;">
			        <div class="jsgrid-grid-header jsgrid-header-scrollbar">
				        <table class="jsgrid-table">
					        <tr class="jsgrid-header-row">
						        <th class="jsgrid-header-cell jsgrid-header-sortable" style="width: 50px;">JetID</th>
						        <th class="jsgrid-header-cell jsgrid-header-sortable" style="width: 100px;">Name</th>
						        <th class="jsgrid-header-cell jsgrid-header-sortable" style="width: 50px;">Weight</th>
                    <th class="jsgrid-header-cell jsgrid-header-sortable" style="width: 70px;">Max Speed</th>
                    <th class="jsgrid-header-cell jsgrid-header-sortable" style="width: 100px;">Flying OfficerID</th>
                    <th class="jsgrid-header-cell jsgrid-header-sortable" style="width: 100px;">StationID</th>
                    ...
                    { ?>
                      <tr class="jsgrid-row">
								        <td class="jsgrid-cell" style="width: 50px;"><?php echo $res['jetid'] ?></td>
								        <td class="jsgrid-cell" style="width: 100px;"><?php echo $res['name'] ?></td>
								        <td class="jsgrid-cell" style="width: 50px;"><?php echo $res['weight'] ?></td>
                        <td class="jsgrid-cell" style="width: 70px;"><?php echo $res['mspeed'] ?></td>
                        <td class="jsgrid-cell" style="width: 100px;"><?php echo $res['empid'] ?></td>
                        <td class="jsgrid-cell" style="width: 100px;"><?php echo $res['sid'] ?></td>
								        <td class="jsgrid-cell jsgrid-align-center" style="width: 50px;"><input name="checkbox[]" value="<?php echo $res['jetid'] ?>" type="checkbox" enabled=""></td>
							        </tr>
                    <?php
                    }
                  ?>
