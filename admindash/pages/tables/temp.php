    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="http://localhost:8080/Project/admindash/pages/tables/temp.php" class="nav-link active">
              <i class="nav-icon fas fa-table"></i>
              <p>
                Accounts Pending
              </p>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Accounts awaiting approval</h1>
          </div>
          <div class="col-sm-6">
      ...
      <form method=post action="deletetemp.php">
        <div class="card">
          ...
          <?php
            include("conn.php");
            error_reporting(0);
            $query="SELECT * FROM temp ORDER BY empid";
                ...
                <table class="jsgrid-table">
                      ...
                      { ?>
                        <tr class="jsgrid-row">
								        ...
								        <td class="jsgrid-cell" style="width: 150px;"><?php echo $res['name'] ?></td>
								        <td class="jsgrid-cell" style="width: 50px;"><?php echo $res['age'] ?></td>
								        <td class="jsgrid-cell" style="width: 100px;"><?php echo $res['contact'] ?></td>
								        <td class="jsgrid-cell jsgrid-align-center" style="width: 100px;"><input name="checkbox[]" value="<?php echo $res['empid'] ?>" type="checkbox" enabled=""></td>
							        </tr>
                    <?php
                    }
                    ?>
          ...
          <button type="submit" name="approve" id="approve" class="login100-form-btn" style="width: 150px;">
			        Approve
				    </button>
