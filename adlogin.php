			...
			<div class="wrap-login100 p-t-85 p-b-20">
				<form class="login100-form validate-form" method="POST">
					<span class="login100-form-title p-b-70">
						ADMIN LOGIN
						<p>Welcome Mr. Arjan Singh!</p>
					</span>
					<span class="login100-form-avatar">
						<img src="/Project/images/avatar-01.jpg" alt="AVATAR">
					</span>
					...
					<div class="container-login100-form-btn">
						...
						$pass=$_POST['pass'];
						$query="SELECT * FROM admin WHERE empid='$empid' and pass='$pass'";
						...
						<script>
  							setTimeout(function(){
								window.location.href= 'http://localhost:8080/Project/admindash/index.php';},4000);
						</script>
    					<?php
						}
						else if($empid!="" && $pass!="")
						{?>
							<p id="error">Invalid login credentials. Please try again!</p>
							<script>
 									setTimeout(function(){
