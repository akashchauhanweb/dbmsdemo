  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"><?php echo $res['name'] ?></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            <a href="http://localhost:8080/Project/userdash/index.php" class="nav-link active">
          ...
          <li class="nav-item has-treeview">
            <a href="http://localhost:8080/Project/userdash/pages/tables/updatedep.php" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="card">
        <!-- /.card-header -->
        <div class="card-body">
          EMPID : <?php echo " ".$_SESSION['empid'];?><br><br>
          NAME : <?php echo " ".$_SESSION['name']; ?><br><br>
          AGE : <?php echo " ".$_SESSION['age'];?><br><br>
          RANK : <?php echo " ".$_SESSION['rank'];?><br><br>
          SALARY : <?php echo " ".$_SESSION['salary'];?><br><br>
          CONTACT : <?php echo " ".$_SESSION['contact'];?><br><br>
          SUPERVISOR NAME :  <?php echo " ".$_SESSION['supername'];?><br><br>
          STATION ASSIGNED : <?php echo " ".$_SESSION['sname'];?><br><br>
          COMMAND ASSOCIATED : <?php echo " ".$_SESSION['cname'];?>
        </div>
        <!-- /.card-body -->
      </div>
        <!-- /.card -->
