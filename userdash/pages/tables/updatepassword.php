...
<?php 
  ...
  $succ=mysqli_query($conn,"SELECT * FROM offusrpass WHERE empid=$empid");
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="http://localhost:8080/Project/userdash/pages/tables/updatepassword.php" class="nav-link active">
              <i class="nav-icon fas fa-edit"></i>
              <p>
                Edit Password
              </p>
        ...
        <div class="card">
          ...
          <?php
            ...
            $conpass=$_POST['conpass'];
              ...
              {               
                $call = "UPDATE offusrpass SET pass='$newpass' WHERE empid=$empid";
